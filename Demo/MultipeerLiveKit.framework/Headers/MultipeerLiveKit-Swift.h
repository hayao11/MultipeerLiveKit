...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MultipeerLiveKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC16MultipeerLiveKit13LivePresenter")
...
SWIFT_CLASS("_TtC16MultipeerLiveKit16MCSessionManager")
...
@interface MCSessionManager (SWIFT_EXTENSION(MultipeerLiveKit)) <MCSessionDelegate>
